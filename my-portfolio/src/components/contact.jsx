...
const socialLinks = [
  {
    href: "https://www.github.com/Agnimn",
    icon: (
      <svg
        width="24"
        height="24"
  ...
  {
    href: "https://www.linkedin.com/in/agni-mn",
    icon: (
      <svg
        width="24"
        height="24"
  ...
  {
    href: "https://www.instagram.com/agni__mn",
    icon: (
      <svg
        width="25"
        height="24"
...
export default function Contact() {
  ...
  const handleSubmit = (e) => {
    ...
    // You can send the form data using fetch or let it submit as normal
    // Here we submit via the action attribute, so we'll manually reset after a slight delay
    const form = e.target;
    form.submit(); // let it send data to getform.io
  ...
  return (
    <section id="contact">
      <div className="container mt-4">
        <h1 className="headline-2">Contact Me</h1>
        <section>
          <div className="container px-4 py-7 rounded-lg">
            <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-8">
              ...
              <div>
                <form
                  action="https://getform.io/f/bpjzxgzb"
                  method="POST"
                ...
                >
                  <div>
                    ...
                    <input
                      ...
                      className="w-full p-3 rounded-md bg-zinc-900 border border-gray-700 text-gray-200 placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-zinc-300"
                    />
                  </div>
                  <div>
                  ...
                  <button
                    type="submit"
                    className="w-full bg-sky-400 hover:bg-sky-300 text-white py-3 rounded-md transition-colors duration-300"
                  >
                    Submit
                  </button>
                </form>
